...
Fk:loadTranslationTable{
    ...
    ["#steam__chizong-log"] = "由于〖<font color='#0598BC'>赤宗</font>〗的效果，%from 对 %to 使用的 %arg 改为按 <font color='#0598BC'>笑里藏刀</font> 结算",

    ["$steam__chizong1"] = "杀生为度生，行恶即抑恶。",
    ["$steam__chizong2"] = "世尊割肉饲鹰，而吾舍身度人。",
}
