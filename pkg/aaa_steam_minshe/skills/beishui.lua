...
Fk:loadTranslationTable{
    ...
    [":steamMinshe__beishui"] = "每个回合结束时，若你手牌数不大于1，你执行一个视为拥有且仅有“<a href = ':steamMinshe__beishui_qingjiao'><font color='#195494'>清剿</font></a>”且“膂力”中的“或”改成“和”的出牌阶段的回合。",
...
beishui:addEffect(fk.TurnEnd, {
    ...
    on_use = function (self, event, target, player, data)
        ...
        player:gainAnExtraTurn(true, beishui.name, { Player.Play })
    end,
})
